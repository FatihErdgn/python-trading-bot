...
CREDENTIALS_PATH = "C:/Users/fther/OneDrive/Masaüstü/BINANCE_TRADING_BOT/settingsE.json"
    ...
    try:
        ...
        if strateji == "1":
            ...
            if ((rsi.iloc[-14:] >= 65).any() or (rsi.iloc[-14:] <= 35).any()) or inPositionShort == True or inPositionLong == True:
                if linRegSignal['Buy_Signal'].iloc[-2] == True and linRegSignal['Sell_Signal'].iloc[-3] == True and obvMacdSignal['Buy_Signal'].iloc[-1] == True:
                    T_F['Buy_Signal'].iloc[0] = True
                    T_F['Sell_Signal'].iloc[0] = False
                elif linRegSignal['Sell_Signal'].iloc[-2] == True and linRegSignal['Buy_Signal'].iloc[-3] == True and obvMacdSignal['Sell_Signal'].iloc[-1] == True:
